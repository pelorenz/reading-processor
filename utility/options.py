...
class  CommandLine:
    def __init__(self, argv):
        ...
        self.parser.add_argument('-N', '--nonmajoritylayers', help='Generate reports on non-majority readings (variantFinder).', action='store_true')
        ...
        self.parser.add_argument('-Y', '--latinlayer', help='Generate reports on Latin-layer readings (variantFinder).', action='store_true')
        ...
        self.parser.add_argument('-D', '--density', help='Compute density of layer or corrector locations (variantFinder).', action='store_true')
